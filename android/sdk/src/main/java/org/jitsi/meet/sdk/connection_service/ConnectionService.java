...
/**
 * Jitsi Meet implementation of {@link ConnectionService}. At the time of this writing it implements
 * only the outgoing call scenario.
 *
 * @author Pawel Domas
 */
...
public class ConnectionService extends android.telecom.ConnectionService {
    ...
    public Connection onCreateOutgoingConnection(
        ...
        moreExtras.putParcelable(EXTRA_PHONE_ACCOUNT_HANDLE, request.getAccountHandle());
        connection.putExtras(moreExtras);

        ConnectionList.getInstance().add(connection);
        Promise startCallPromise
            = ConnectionList.getInstance().unregisterStartCallPromise(connection.getCallUUID());
        ...
        // TODO Implement video state. Currently there's not much use of it without the incoming
        // call scenario.
        //
    ...
    public void onCreateOutgoingConnectionFailed(
        ...
        if (callUUID != null) {
            ...
            Log.e(TAG, "onCreateOutgoingConnectionFailed - no call UUID in the request");
        }
    }
     ...
     * @param address the phone account's address. At the time of this writing it's the call handle
     * passed from the Java Script side.
